...
MyGame.objects.Info = function(spec) {
    ...
    var currentGraphics = ['a','b','c','d','f','i','m','n','o','p','q','r','s','t','w','z']
    function render(){
        MyGame.render.Text.render(myLetter);
        // MyGame.render.Text.render(myLives);
        MyGame.render.Text.render(myScore);
        drawAnswer(0,MyGame.graphics.canvas.width*0.2,MyGame.graphics.canvas.height*0.35, currentGraphics.find(function(l){return l == spec.answer[0]}) == undefined ? 'bcgames-filler.png' : MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[0]].images[MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[0]].animals.indexOf(left.text)]);
        drawAnswer(1,MyGame.graphics.canvas.width*0.5,MyGame.graphics.canvas.height*0.35, currentGraphics.find(function(l){return l == spec.answer[1]}) == undefined ? 'bcgames-filler.png' : MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[1]].images[MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[1]].animals.indexOf(mid.text)]);
        drawAnswer(2,MyGame.graphics.canvas.width*0.8,MyGame.graphics.canvas.height*0.35, currentGraphics.find(function(l){return l == spec.answer[2]}) == undefined ? 'bcgames-filler.png' : MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[2]].images[MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[2]].animals.indexOf(right.text)]);
        drawAnswer(3,MyGame.graphics.canvas.width*0.2,MyGame.graphics.canvas.height*0.75, currentGraphics.find(function(l){return l == spec.answer[3]}) == undefined ? 'bcgames-filler.png' : MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[3]].images[MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[3]].animals.indexOf(bleft.text)]);
        drawAnswer(4,MyGame.graphics.canvas.width*0.5,MyGame.graphics.canvas.height*0.75, currentGraphics.find(function(l){return l == spec.answer[4]}) == undefined ? 'bcgames-filler.png' : MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[4]].images[MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[4]].animals.indexOf(bmid.text)]);
        drawAnswer(5,MyGame.graphics.canvas.width*0.8,MyGame.graphics.canvas.height*0.75, currentGraphics.find(function(l){return l == spec.answer[5]}) == undefined ? 'bcgames-filler.png' : MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[5]].images[MyGame.objects.AnimalDict[localStorage.LearnProLang][spec.answer[5]].animals.indexOf(bright.text)]);
        if(renderAnswers){
